...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Produto prod4 = new Produto(null, "Mesa de escrotório", 300.0);
		Produto prod5 = new Produto(null, "Toalha", 50.0);
		Produto prod6 = new Produto(null, "Colcha", 200.0);
		...
		Produto prod11 = new Produto(null, "Shampoo", 90.0);
		...
		Cliente cli2 = new Cliente(null, "Mario Silva", "mario@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("246"));
		Cliente cli3 = new Cliente(null, "Ana Costa", "gabrielribeiroalmeida6@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "456", "Sala 800", "Centro", "38777012", cli1, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("14/01/2024 14:03"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("01/01/2024 14:03"), cli1, e2);

		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);

		ped1.setPagamento(pagto1);

		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("02/02/2024 00:00"),
				null);
