...
public class ClienteService {
	...
	public Cliente update(Cliente obj) {
		...
		Cliente newObj = repo.getReferenceById(obj.getId());
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityViolationException("erro ao excluir");
		}
	...
	public Cliente findByEmail(String email) {
		...
		if(obj == null) {
			...
			throw new ObjectNotFoundException("Objeto não encontrado! Id: "+user.getPassword() + "Tipo: "+ Cliente.class.getName());
		}
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		return s3Service.uploadFile(imageService.getInputStream(jpgImage, fileName),fileName,"image");
	}
